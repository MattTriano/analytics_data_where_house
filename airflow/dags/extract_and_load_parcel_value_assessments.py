...
SOCRATA_TABLE = cook_county_parcel_value_assessments
...
def update_cc_parcel_assessments_table():
...
cook_county_parcel_value_assessments_dag = update_cc_parcel_assessments_table()
