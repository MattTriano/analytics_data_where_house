...
from sources.tables import COOK_COUNTY_SAO_CASE_SENTENCING_DATA as SOCRATA_TABLE
...
def update_ccsao_case_sentencing_data():
...
update_ccsao_case_sentencing_data()
