...
from sources.census_api_datasets import (
    CC_HOUSING_TENURE_SINGLE_RACE_BY_TRACT_ACS5 as CENSUS_DATASET,
)
...
def update_cc_housing_tenure_single_race_by_tract_acs5():
    update_census_table(
...
update_cc_housing_tenure_single_race_by_tract_acs5()
