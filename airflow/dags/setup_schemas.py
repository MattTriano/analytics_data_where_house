...
def setup_schemas():
    ...
    # )
    # setup_dwh_schema_1 = ensure_schema_exists(
    #     schema_name="dwh", conn_id="dwh_db_conn", task_logger=task_logger
    # )
    # setup_feature_schema_1 = ensure_schema_exists(
    #     schema_name="feature", conn_id="dwh_db_conn", task_logger=task_logger
    # )
    # setup_report_schema_1 = ensure_schema_exists(
    #     schema_name="report", conn_id="dwh_db_conn", task_logger=task_logger
    # )

    # setup_data_raw_schema_1
    # setup_clean_schema_1
    # setup_dwh_schema_1
    # setup_feature_schema_1
    # setup_report_schema_1
