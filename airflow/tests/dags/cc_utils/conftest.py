...
def table_metadata_df() -> pd.DataFrame:
    ...
    'source_data_last_updated': pd.Timestamp('2022-12-01 06:16:57+0000', tz='UTC'),
    'source_metadata_last_updated': pd.Timestamp('2022-12-01 06:11:38+0000', tz='UTC'),
    'updated_data_available': False,
    'updated_metadata_available': False,
    'data_pulled_this_check': False,
    'time_of_check': pd.Timestamp('2022-12-06 00:50:37.561656+0000', tz='UTC'),
    'metadata_json': {}},
    {'id': 78,
    'table_id': 'wyzt-dzf8',
