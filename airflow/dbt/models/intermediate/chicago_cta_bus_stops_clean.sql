...
{% set base_cols = [
    "systemstop", "public_name", "dir", "street", "cross_st", "city", "routesstpg", "owlroutes",
    "pos", "geometry", "source_data_updated", "ingestion_check_time"
] %}

-- selects all records from the standardized view of this data
WITH std_data AS (
    SELECT *
    FROM {{ ref('chicago_cta_bus_stops_standardized') }}
),
