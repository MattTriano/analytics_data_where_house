...
WITH records_with_basic_cleaning AS (
    SELECT
        ...
        num_bus_stop_in_half_mile::smallint                   AS num_bus_stop_in_half_mile,
        num_bus_stop_data_year::smallint                      AS num_bus_stop_data_year,
        ...
        num_school_in_half_mile::smallint                     AS num_school_in_half_mile,
        num_school_data_year::smallint                        AS num_school_data_year,
        ...
        nearest_bike_trail_data_year::smallint                AS nearest_bike_trail_data_year,
        nearest_cemetery_gnis_code::bigint                    AS nearest_cemetery_gnis_code,
        ...
        nearest_cemetery_data_year::smallint                  AS nearest_cemetery_data_year,
        ...
        nearest_cta_route_data_year::smallint                 AS nearest_cta_route_data_year,
        nearest_cta_stop_id::bigint                           AS nearest_cta_stop_id,
        ...
        nearest_cta_stop_data_year::smallint                  AS nearest_cta_stop_data_year,
        ...
        nearest_golf_course_data_year::smallint               AS nearest_golf_course_data_year,
        nearest_hospital_gnis_code::bigint                    AS nearest_hospital_gnis_code,
        ...
        nearest_hospital_data_year::smallint                  AS nearest_hospital_data_year,
        lake_michigan_dist_ft::double precision               AS lake_michigan_dist_ft,
        lake_michigan_data_year::smallint                     AS lake_michigan_data_year,
        nearest_major_road_osm_id::bigint                     AS nearest_major_road_osm_id,
        ...
        nearest_major_road_data_year::smallint                AS nearest_major_road_data_year,
        ...
        nearest_metra_route_data_year::smallint               AS nearest_metra_route_data_year,
        ...
        nearest_metra_stop_data_year::smallint                AS nearest_metra_stop_data_year,
        nearest_park_osm_id::bigint                           AS nearest_park_osm_id,
        upper(nearest_park_name::text)                        AS nearest_park_name,
        nearest_park_dist_ft::double precision                AS nearest_park_dist_ft,
        nearest_park_data_year::smallint                      AS nearest_park_data_year,
        nearest_railroad_id::smallint                         AS nearest_railroad_id,
        ...
        nearest_railroad_data_year::smallint                  AS nearest_railroad_data_year,
        nearest_secondary_road_osm_id::bigint                 AS nearest_secondary_road_osm_id,
        ...
        nearest_secondary_road_data_year::smallint            AS nearest_secondary_road_data_year,
        nearest_water_id::bigint                              AS nearest_water_id,
        upper(nearest_water_name::text)                       AS nearest_water_name,
        nearest_water_dist_ft::double precision               AS nearest_water_dist_ft,
        nearest_water_data_year::smallint                     AS nearest_water_data_year,
